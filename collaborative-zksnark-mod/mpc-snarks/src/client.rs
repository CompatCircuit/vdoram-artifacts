...
impl Computation {
    fn run_bls_compat_circuit(&self, compat_circuit_r1cs_json_path: &str) {
        match self {
            Computation::PlonkCompatCircuitMultiParty => {
                plonk::mpc_prove_and_verify_compat_circuit(compat_circuit_r1cs_json_path);
            }
            Computation::PlonkCompatCircuitLocal => {
                plonk::local_prove_and_verify_compat_circuit(compat_circuit_r1cs_json_path);
            }
